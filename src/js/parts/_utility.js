...
export {
    $, tween, isIOs, isMobile, isTouch, $wnd, $doc, $html, $body, wndW, wndH, docH, debounceResize, throttleScroll, bodyOverflow, scrollbarWidth, isBodyOverflowed, isInViewport, scrollTo,
};
